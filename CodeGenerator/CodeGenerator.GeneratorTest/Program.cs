...
namespace CodeGenerator.GeneratorTest
{
    class Program
    {
        ...
        public static void generatorTest()
        {
            ...
            // 3 classes
            dm.UML_Class class1 = new dm.UML_Class("public", "class1", new List<dm.UML_Attribute>() { att1 }, new List<dm.UML_Method>() { method1 }, null, new List<dm.UML_Interface>());
            dm.UML_Class class2 = new dm.UML_Class("private", "class2", new List<dm.UML_Attribute>() { att1, att2, att3, att4 }, new List<dm.UML_Method>() { method1, method2, method3 }, null, new List<dm.UML_Interface>());
            dm.UML_Class class3 = new dm.UML_Class("public", "class3", new List<dm.UML_Attribute>() { att1, att2, att3, att4 }, new List<dm.UML_Method>() { method1, method2, method3 }, class1, new List<dm.UML_Interface>() { interface1, interface2 });
